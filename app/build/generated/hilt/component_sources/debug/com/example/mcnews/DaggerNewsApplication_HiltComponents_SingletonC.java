...
import com.example.mcnews.di.AppModule_ProvideContextFactory;
import com.example.mcnews.di.NetworkModule_ProvideApiServiceFactory;
import com.example.mcnews.di.NetworkModule_ProvideOkHttpClientFactory;
import com.example.mcnews.di.NetworkModule_ProvideRetrofitFactory;
import com.example.mcnews.domain.repo.ArticleRepository;
import com.example.mcnews.domain.repo.AuthRepository;
import com.example.mcnews.ui.articles.ArticlesFragment;
import com.example.mcnews.ui.articles.ArticlesFragment_MembersInjector;
import com.example.mcnews.ui.articles.ArticlesViewModel;
import com.example.mcnews.ui.articles.ArticlesViewModel_HiltModules;
import com.example.mcnews.ui.auth.AuthViewModel;
import com.example.mcnews.ui.auth.AuthViewModel_HiltModules;
import com.example.mcnews.ui.auth.LoginFragment;
import com.example.mcnews.ui.auth.RegisterFragment;
import com.example.mcnews.ui.edit.EditArticleActivity;
import com.example.mcnews.ui.edit.EditArticleActivity_MembersInjector;
import com.example.mcnews.ui.edit.EditArticleViewModel;
import com.example.mcnews.ui.edit.EditArticleViewModel_HiltModules;
...
public final class DaggerNewsApplication_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends NewsApplication_HiltComponents.FragmentC {
    ...
    @Override
    public void injectArticlesFragment(ArticlesFragment arg0) {
      injectArticlesFragment2(arg0);
    }
    ...
    private ArticlesFragment injectArticlesFragment2(ArticlesFragment instance) {
      ArticlesFragment_MembersInjector.injectApi(instance, singletonCImpl.provideApiServiceProvider.get());
      return instance;
    }
  }
  ...
  private static final class ActivityCImpl extends NewsApplication_HiltComponents.ActivityC {
    ...
    @Override
    public void injectEditArticleActivity(EditArticleActivity arg0) {
      injectEditArticleActivity2(arg0);
    }
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(3).put(LazyClassKeyProvider.com_example_mcnews_ui_articles_ArticlesViewModel, ArticlesViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_example_mcnews_ui_auth_AuthViewModel, AuthViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_example_mcnews_ui_edit_EditArticleViewModel, EditArticleViewModel_HiltModules.KeyModule.provide()).build());
    }
    ...
    @CanIgnoreReturnValue
    private EditArticleActivity injectEditArticleActivity2(EditArticleActivity instance) {
      EditArticleActivity_MembersInjector.injectApi(instance, singletonCImpl.provideApiServiceProvider.get());
      return instance;
    }

    @IdentifierNameString
    private static final class LazyClassKeyProvider {
      static String com_example_mcnews_ui_articles_ArticlesViewModel = "com.example.mcnews.ui.articles.ArticlesViewModel";

      static String com_example_mcnews_ui_auth_AuthViewModel = "com.example.mcnews.ui.auth.AuthViewModel";

      static String com_example_mcnews_ui_edit_EditArticleViewModel = "com.example.mcnews.ui.edit.EditArticleViewModel";

      @KeepFieldType
      ArticlesViewModel com_example_mcnews_ui_articles_ArticlesViewModel2;

      @KeepFieldType
      AuthViewModel com_example_mcnews_ui_auth_AuthViewModel2;

      @KeepFieldType
      EditArticleViewModel com_example_mcnews_ui_edit_EditArticleViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends NewsApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.editArticleViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(3).put(LazyClassKeyProvider.com_example_mcnews_ui_articles_ArticlesViewModel, ((Provider) articlesViewModelProvider)).put(LazyClassKeyProvider.com_example_mcnews_ui_auth_AuthViewModel, ((Provider) authViewModelProvider)).put(LazyClassKeyProvider.com_example_mcnews_ui_edit_EditArticleViewModel, ((Provider) editArticleViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.mcnews.ui.articles.ArticlesViewModel 
          return (T) new ArticlesViewModel(singletonCImpl.bindArticleRepositoryProvider.get());

          case 1: // com.example.mcnews.ui.auth.AuthViewModel 
          return (T) new AuthViewModel(singletonCImpl.bindAuthRepositoryProvider.get());

          case 2: // com.example.mcnews.ui.edit.EditArticleViewModel 
          return (T) new EditArticleViewModel(singletonCImpl.bindArticleRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends NewsApplication_HiltComponents.SingletonC {
    ...
    private Provider<ArticleRepository> bindArticleRepositoryProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.articleRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 3);
      this.bindArticleRepositoryProvider = DoubleCheck.provider((Provider) articleRepositoryImplProvider);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.mcnews.data.remote.ApiService 
          ...
          case 3: // com.example.mcnews.data.repo.ArticleRepositoryImpl 
          return (T) new ArticleRepositoryImpl(singletonCImpl.provideContextProvider.get(), singletonCImpl.provideOkHttpClientProvider.get());
          ...
          case 5: // com.example.mcnews.data.repo.AuthRepositoryImpl 
          return (T) new AuthRepositoryImpl(singletonCImpl.provideContextProvider.get(), singletonCImpl.provideOkHttpClientProvider.get());
